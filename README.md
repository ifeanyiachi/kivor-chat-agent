...
**Contributors:** ifeanyiachi, kivorsuite  
**Tags:** ai chatbot, woocommerce chatbot, customer support, live chat, wordpress chatbot  
...
- Basic chatbot administration and styling controls.
- Limited webpage scanning.
...
- Additional knowledge sources, including Zendesk and Notion. Connect more external systems to expand the assistant's answer sources.
- Advanced embedding provider support. Use a wider range of embedding models for better search and retrieval quality.
- Pinecone and Qdrant vector store support. Store and query vectors in external services for scalable semantic search.
- Analytics insights and chat log tools. Review usage patterns, conversation activity, and performance signals.
- Forms integration. Capture leads and user details through configurable forms.
- Phone call features. Add call-related workflows for users who need a more direct support path.
- Advanced styling options. Unlock deeper control over the chat widget's appearance and presentation.
- Additional admin sections for pro settings. Manage premium capabilities from dedicated settings panels.
...
1. Upload the plugin files to the `/wp-content/plugins/kivor-chat-agent/` directory, or install the plugin through the WordPress Plugins screen.
2. Activate the plugin through the `Plugins` screen in WordPress.
3. Open the Kivor Chat Agent settings page and configure your AI provider, embeddings, knowledge sources, and storefront settings.
4. Add the required API keys and publish the chat widget to your store.
