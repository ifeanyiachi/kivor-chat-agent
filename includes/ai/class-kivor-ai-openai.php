...
class Kivor_AI_OpenAI extends Kivor_AI_Provider {
    ...
    public function chat( array $messages, array $options = array() ) {
        ...
        // Validate messages structure (VULN-015 fix).
        $valid_msgs = $this->validate_messages( $messages );
        if ( is_wp_error( $valid_msgs ) ) {
            return $valid_msgs;
        }
    ...
    public function test_connection() {
        ...
        // Send a minimal request to verify the key and model.
        $response = $this->chat(
            array(
